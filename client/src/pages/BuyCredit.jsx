...
import "react-toastify/dist/ReactToastify.css"; // ✅ FIX: Toast styles

const BuyCredit = () => {
  const { backendUrl, localCreditsData } = useContext(AppContext);
  ...
  const initPay = async (order) => {
    ...
    const options = {
      ...
      handler: async (response) => {
        ...
        // You can call backend here to verify payment if needed
      },
      theme: { color: "#000000" },
    };
