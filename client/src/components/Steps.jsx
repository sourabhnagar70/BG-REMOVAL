...
const Steps = () => {
  return (
    <div className='mx-4 lg:mx-44 py-20 xl:py-40'>
      ...
      <div className=' flex flex-row flex items-start flex-wrap gap-4 mt-16 xl:mt-24 justify-center-'>

        <div className='flex flex-1 items-start gap-4 bg-white border drop-shadow-md p-7 pb-10 rounded hover:scale-105 transition-all duration-500 '>
